export type OptifiExchangeIDL = {
    ...
    instructions: [
        {
            ...
            accounts: [
                ...
                { name: "usdcCentralPool"; isMut: false; isSigner: false; docs: ["usdc central pool for fund settlement, its authority should be the central_usdc_pool_auth_pda"] },
                { name: "usdcFeePool"; isMut: false; isSigner: false; docs: ["usdc fee pool for trade fee collection, its authority should be the central_usdc_pool_auth_pda"] },
        ...
        },
        {
            ...
            accounts: [{ name: "optifiExchange"; isMut: true; isSigner: false }, { name: "clock"; isMut: false; isSigner: false; docs: ["Clock to get the timestamp"] }];
            args: [];
        },
        {
            ...
            args: [{ name: "coinLotSize"; type: "u64" }, { name: "pcLotSize"; type: "u64" }, { name: "vaultSignerNonce"; type: "u64" }, { name: "pcDustThreshold"; type: "u64" }];
        },
        {
        ...
        },
        {
            ...
            accounts: [
                ...
                { name: "serumMarketAuthority"; isMut: false; isSigner: false; docs: ["serum market authority which is required when init open orders if it is Some()"] },
        ...
        },
        {
            ...
            accounts: [
                ...
                { name: "ammLiquidityAuth"; isMut: false; isSigner: false; docs: ["amm's lp token mint authority, and usdc vault authority"] },
                {
                    ...
                    isMut: true;
                    isSigner: false;
                    docs: ["user's token vault for receiving lp tokens", "in order to calc the performance fee, the authority of the lp token vault must be user account"];
                },
        ...
        },
        {
            ...
            args: [{ name: "orderLimit"; type: "u16" }, { name: "instrumentIndex"; type: "u16" }, { name: "ammAuthorityBump"; type: "u8" }, { name: "marketAuthBump"; type: "u8" }];
        },
        {
        ...
        },
        {
            ...
            accounts: [
                ...
                { name: "pcVault"; isMut: true; isSigner: false; docs: ['The vault for the "quote" currency'] },
                { name: "instrumentTokenMintAuthorityPda"; isMut: false; isSigner: false; docs: ["the mint authoriity of both long and short spl tokens"] },
                { name: "instrumentLongSplTokenMint"; isMut: true; isSigner: false; docs: ['The token mint address of "base" currency, aka the instrument long spl token'] },
                { name: "instrumentShortSplTokenMint"; isMut: true; isSigner: false; docs: ["the instrument short spl token"] },
                { name: "ammInstrumentLongTokenVault"; isMut: true; isSigner: false },
                { name: "ammInstrumentShortTokenVault"; isMut: true; isSigner: false; docs: ["amm's instrument short spl token account"] },
        ...
        },
        {
            ...
            args: [{ name: "side"; type: { defined: "OrderSide" } }, { name: "limit"; type: "u64" }, { name: "maxCoinQty"; type: "u64" }, { name: "maxPcQty"; type: "u64" }];
        },
        {
            name: "mmCalculation";
            accounts: [
        ...
        },
        {
            name: "updateOracle";
            accounts: [{ name: "optifiExchange"; isMut: true; isSigner: false }, { name: "operationAuthority"; isMut: false; isSigner: true }];
            args: [{ name: "asset"; type: { defined: "Asset" } }, { name: "spotOracle"; type: { option: "publicKey" } }, { name: "ivOracle"; type: { option: "publicKey" } }];
        },
        {
            name: "setDelegation";
            accounts: [
    ...
    types: [
        ...
        { name: "Order"; type: { kind: "struct"; fields: [{ name: "price"; type: "u64" }, { name: "size"; type: "u64" }, { name: "clientOrderId"; type: "u64" }] } },
        {
            name: "UserPosition";
        ...
        { name: "FeeTier"; type: { kind: "enum"; variants: [{ name: "Level1" }, { name: "Level2" }, { name: "Level3" }] } },
        { name: "LiquidationStatus"; type: { kind: "enum"; variants: [{ name: "Healthy" }, { name: "CancelOrder" }, { name: "PlaceOrder" }, { name: "SettleOrder" }] } },
        ...
        { name: "AccountState"; docs: ["Account state."]; type: { kind: "enum"; variants: [{ name: "Uninitialized" }, { name: "Initialized" }, { name: "Frozen" }] } },
