                                                                                                                                ...
                                                                                                                                findMarginStressWithAsset(
                                                                                                                                    ...
                                                                                                                                    .then(async ([marginStressAddress, _bump]) => {
                                                                                                                                        ...
                                                                                                                                        let limit =
                                                                                                                                            ...
                                                                                                                                            10 **
                                                                                                                                                numberAssetToDecimal(chain.asset)!; // price for 1 lot_size
                                                                                                                                        let maxCoinQty =
                                                                                                                                            size *
                                                                                                                                            10 **
                                                                                                                                                numberAssetToDecimal(chain.asset)!;
                                                                                                                                        let PcQty = limit * maxCoinQty;
                                                                                                                                        let [maxPcQty] = calculatePcQtyAndFee(
                                                                                                                                            context,
                                                                                                                                            0,
                                                                                                                                            size,
                                                                                                                                            PcQty,
                                                                                                                                        ...
                                                                                                                                        let marketMakerPostOnlyOrderTx =
                                                                                                                                            context.program.rpc.mmPostOnlyOrder(
                                                                                                                                                side,
                                                                                                                                                new BN(limit),
                                                                                                                                                new BN(maxCoinQty),
                                                                                                                                                new BN(maxPcQty),
                                                                                                                                        ...
                                                                                                                                        marketMakerPostOnlyOrderTx
                                                                                                                                            .then((res) => {
                                                                                                                                                console.log(
                                                                                                                                                    "Successfully placed market maker post-only order",
