...
import { SERUM_DEX_PROGRAM_ID, OPUSDC_TOKEN_MINT } from "../../constants";
...
export default function marketMakerCancelOrder(context: Context, marketAddress: PublicKey): Promise<InstructionResult<TransactionSignature>> {
                                                                    ...
                                                                    .then((serumMarket) => {
                                                                        getDexOpenOrders(context, optifiMarket.serumMarket, userAccountAddress)
                                                                            .then(([userOpenOrdersAccount, _]) => {
                                                                                deriveVaultNonce(optifiMarket.serumMarket, serumProgramId)
                                                                                    .then(([vaultSigner, vaultNonce]) => {
                                                                                        findSerumAuthorityPDA(context)
                                                                                            .then(([serumMarketAuthority, bump2]) => {
                                                                                                                    ...
                                                                                                                    .then(([userShortTokenVault, _]) => {
                                                                                                                        context.program.account.chain
                                                                                                                            ...
                                                                                                                            .then((chainRes) => {
                                                                                                                                ...
                                                                                                                                findMarginStressWithAsset(
                                                                                                                                    context,
                                                                                                                                    exchangeAddress,
                                                                                                                                    chain.asset
                                                                                                                                )
                                                                                                                                    .then(async ([marginStressAddress, _bump]) => {
                                                                                                                                        let marketMakerCalculationTx =
                                                                                                                                            context.program.instruction.mmCalculation(
                                                                                                                                                {
                                                                                                                                                    accounts: {
                                                                                                                                                        optifiExchange:
                                                                                                                                                            exchangeAddress,
                                                                                                                                                        ...
                                                                                                                                                        userAccount:
                                                                                                                                                            userAccountAddress,
                                                                                                                                                        userMarginAccount:
                                                                                                                                                            userAcctRaw.userMarginAccountUsdc,
                                                                                                                                                        marketMakerAccount:
                                                                                                                                                            marketMakerAccount,
                                                                                                                                        ...
                                                                                                                                        let marginStressIx = await marginStress(
                                                                                                                                            context,
                                                                                                                                            chain.asset
                                                                                                                                        );
                                                                                                                                        ...
                                                                                                                                        let marketMakerCancelOrderTx =
                                                                                                                                            context.program.rpc.mmCancelOrder({
                                                                                                                                                accounts: {
                                                                                                                                        ...
                                                                                                                                        marketMakerCancelOrderTx
                                                                                                                                            .then((res) => {
                                                                                                                                                console.log(
                                                                                                                                                    "Successfully cancelled market maker order",
